...
$jscomp.polyfill = function (d, c, l, w) {
  if (c) {
    ...
    c != w &&
      null != c &&
      $jscomp.defineProperty(l, d, { configurable: !0, writable: !0, value: c })
  }
}
...
$jscomp.polyfill(
  ...
  function (d) {
    ...
    p.prototype.resolveTo_ = function (c) {
      ...
      else if (c instanceof p) this.settleSameAsPromise_(c)
      else {
        a: switch (typeof c) {
          case 'object':
            var d = null != c
    ...
    p.prototype.resolveToNonPromiseObj_ = function (c) {
      ...
      'function' == typeof d
        ? this.settleSameAsThenable_(d, c)
        : this.fulfill_(c)
    }
    ...
    p.race = function (c) {
      return new p(function (d, p) {
        for (
          var k = $jscomp.makeIterator(c), n = k.next();
          !n.done;
          n = k.next()
        )
...
$jscomp.initSymbolIterator = function () {
  ...
  d ||
    (d = $jscomp.global.Symbol.iterator =
...
$jscomp.initSymbolAsyncIterator = function () {
  ...
  d ||
    (d = $jscomp.global.Symbol.asyncIterator =
...
$jscomp.setPrototypeOf =
  'function' == typeof Object.setPrototypeOf
    ...
    ? function (d, c) {
        d.__proto__ = c
        if (d.__proto__ !== c) throw new TypeError(d + ' is not extensible')
        return d
      }
    : null
$jscomp.generator = {}
...
$jscomp.generator.Context.prototype.yieldAll = function (d, c) {
  ...
  if (l.done) (this.yieldResult = l.value), (this.nextAddress = c)
  else return (this.yieldAllIterator_ = d), this.yield(l.value, c)
}
...
$jscomp.generator.Context.prototype.enterFinallyBlock = function (d, c, l) {
  l
    ? (this.finallyContexts_[l] = this.abruptCompletion_)
...
$jscomp.generator.Context.PropertyIterator = function (d) {
  this.object_ = d
  this.properties_ = []
  for (var c in d) this.properties_.push(c)
...
$jscomp.generator.Engine_.prototype.yieldAllStep_ = function (d, c, l) {
  try {
    ...
    if (!w.done) return this.context_.stop_(), w
    var p = w.value
  } catch (v) {
    return (
...
;(function (d, c) {
  ...
  function p(a, b, e) {
    ...
    var f = this.createCanvas(),
      m = f.canvas
    f = f.context
    var d = new c.SpriteMaterial({ color: a, map: this.createCanvasTexture(m) })
  ...
  function v(a, b, e) {
    ...
    e = function (b) {
      if (this.material) {
        ...
        e.copy(this.scale)
        this.scaleUpAnimation = new q.Tween(this.scale)
          .to({ x: 1.3 * e.x, y: 1.3 * e.y }, 500)
          .easing(q.Easing.Elastic.Out)
        this.scaleDownAnimation = new q.Tween(this.scale)
          .to({ x: e.x, y: e.y }, 500)
          .easing(q.Easing.Elastic.Out)
        this.material.map = b
    ...
    this.showAnimation = new q.Tween(this.material)
      .to({ opacity: 1 }, 500)
      .onStart(this.enableRaycast.bind(this, !0))
      .easing(q.Easing.Quartic.Out)
    this.hideAnimation = new q.Tween(this.material)
      .to({ opacity: 0 }, 500)
  ...
  function k() {
    ...
    this.infospotAnimation = new q.Tween(this).to(
      {},
  ...
  function fa() {
    for (var a = [], b = 0; 6 > b; b++) a.push(C.WhiteTile)
    U.call(this, a)
  ...
  function wa(a, b, e, f) {
      ...
      return $jscomp.asyncExecutePromiseGeneratorProgram(function (t) {
        switch (t.nextAddress) {
          ...
          case 4:
            ...
            return t.yield(fetch(a, { headers: d, method: 'GET' }), 9)
          case 9:
            return (u = t.yieldResult), t.yield(u.arrayBuffer(), 10)
          case 10:
            ;(h = t.yieldResult), (y[m.index] = h), H++, (c = !0)
          case 7:
            t.enterFinallyBlock()
    ...
    function L(a, b) {
      if (null != a && '' !== a) {
        ...
        f.open('GET', a, !0)
        b &&
          ((f.responseType = b.responseType),
          b.onreadystatechange &&
            (f.onreadystatechange = b.onreadystatechange.bind(f)),
    ...
    function k(a, b, f, e) {
      var c = [],
        m = 0
      if (void 0 === e ? 0 : e) {
        for (b = 0; b < a.length; b++) c.push(l(a[b], b, !1))
        return c
      }
      ...
      d = b + d
      for (b = 0; b < d; b++)
        a[b * e] && (c.push(l(a[b * e], b * e, m++, !0, d)), f.push(b * e))
      d = c.length
      for (b = 0; b < c.length; b++) c[b].firstPassCompleteIndex = d
      f = e
      m = 0
      ...
      f = []
      for (b = 0; b < c.length; b++) f[c[b].index] = c[b].index
      for (b = 0; b < a.length; b++) f[b] || c.push(l(a[b], b, m++, !1, d))
      a = (function (a, b) {
    ...
    navigator.userAgent.match(/Android/i)
      ? (B = !0)
      : navigator.userAgent.match(/iPhone|iPad|iPod/i) && (C = !0)
    if (
      /Chrome/i.test(navigator.userAgent.toLowerCase()) ||
      /Chrome WebView/i.test(navigator.userAgent.toLowerCase()) ||
      /Chromium/i.test(navigator.userAgent.toLowerCase())
    )
      var W = !0
    else if (
      /Firefox/i.test(navigator.userAgent.toLowerCase()) ||
      /Supermedium/i.test(navigator.userAgent.toLowerCase())
    ) {
      var O = !0
      B || (W = !0)
    } else
    ...
    } else r.setAttribute('playsinline', ''), (r.muted = !0), (r.autoplay = !0)
    ...
    this.render = function (a) {
      if (ba) {
        ...
        ja = 360 / A.frameCount
        F.clockwise ? 0 > G && (G = 360 + G) : ((G = -G), (G = 540 + G))
        G %= 360
        I = parseInt(Math.round(G / ja), 10)
        if (I == A.frameCount && F.moment_type) I = A.frameCount - 1
        else if ((I == A.frameCount && !F.moment_type) || !I) I = 0
        if (A.textureReady() && M != I) {
          if (W) {
            if (0 == ia.length || y[I]) var f = I
            else {
              var e = !1,
                c = !1
              ...
              f || (f = A.frameCount)
              f =
                Math.abs(I - f) <= Math.abs(I - m) && f == A.frameCount
                  ? 0
                  : Math.abs(I - f) <= Math.abs(I - m)
                  ? f
                  : m
            }
            f || (f = 0)
              ...
              ? y[f] &&
                ...
                (f < A.frameCount
                  ? ((r.currentTime += 1 / q),
                    ...
                    F.aligned
                      ? n.appendBuffer(y[f])
                      : n.appendBuffer(y[(f + framePadding) % A.frameCount]))
                  : console.log('Invalid Index'))
              : C || O
              ? F.aligned
                ? r.fastSeek((1 * f) / q)
                : r.fastSeek(((f + framePadding) % A.frameCount) / q)
              : (r.currentTime = (1 * f) / q))
          M = I
        }
        b(r, F)
        ...
        console.log(
          'Render called before download is ready. Wait for Ready callback before calling Render.'
        )
    }
    ...
    this.textureReady = function () {
      return (!W && 1 == da && r.readyState === r.HAVE_ENOUGH_DATA) ||
        (W && ((O && 3 <= r.readyState) || r.readyState === r.HAVE_ENOUGH_DATA))
        ? !0
        : !1
    }
    var Z = function (a) {
          ...
          switch (k.nextAddress) {
            case 1:
              ;(b = new Headers()),
                ...
                -1 < a.indexOf('https://data.panomoments.com/')
                  ? (a = a.replace(
                      /data.panomoments.com/i,
                      's3.amazonaws.com/data.panomoments.com'
                    ))
                  : -1 < a.indexOf('https://staging-data.panomoments.com/') &&
                    (a = a.replace(
                      /staging-data.panomoments.com/i,
                      's3.amazonaws.com/staging-data.panomoments.com'
                    )),
                b.append('Range', f),
                (e = 0),
                (c = !1)
            case 2:
              ...
              return k.yield(fetch(a, { headers: b, method: 'GET' }), 6)
            case 6:
              return (m = k.yieldResult), k.yield(m.arrayBuffer(), 7)
            case 7:
              d = k.yieldResult
              J = new Uint8Array(d)
              u = ka(J, S)
      ...
      T = function (a) {
        ;(!n || (n && n.updating)) && 0 == K
          ? (console.log('Buffer not ready. Retrying in 1 second.'),
            setTimeout(function () {
              T(a)
            }, 1e3))
          : a &&
          ...
          switch (G.nextAddress) {
            case 1:
              ;(f = new Headers()),
                ...
                (c =
                  'bytes=' +
                  w[A.currentIndex].getAttribute('mediaRange').toString()),
                f.append('Range', c),
                -1 < a.indexOf('https://data.panomoments.com/')
                  ? (a = a.replace(
                      /data.panomoments.com/i,
            ...
            case 2:
              ...
              return G.yield(fetch(a, { headers: f, method: 'GET' }), 6)
            case 6:
              return (u = G.yieldResult), G.yield(u.arrayBuffer(), 7)
            case 7:
              h = G.yieldResult
              x = new Uint8Array(h)
              ...
              W
                ? ((y[A.currentIndex] = h),
                  ...
                  b(r, F),
                  (ia = k(w, z, v, !1)))
                : (r.addEventListener('loadeddata', X),
                  r.addEventListener('canplay', Y),
                  (r.src = window.URL.createObjectURL(
      ...
      fa = function (a) {
        ...
        var f = new IntersectionObserver(function (a) {
          a[0].isIntersecting &&
            (f.disconnect(), document.body.removeChild(b), aa())
        })
        f.observe(b)
      },
      aa = function (a) {
      ...
      ka = function (a, b, f) {
        f = a.indexOf(b[0], f || 0)
        if (1 === b.length || -1 === f) return f
        for (var e = f, c = 0; c < b.length && e < a.length; e++, c++)
          if (a[e] !== b[c]) return ka(J, b, f + 1)
  ...
  function oa(a, b) {
      ...
      if (!1 !== h.enabled) {
        ...
        E === y.ROTATE
          ? !0 !== h.noRotate &&
            ...
            n.subVectors(l, L),
            0 == L.x && 0 == L.y
              ? (L.set(l.x, l.y), n.subVectors(l, L))
              : (h.rotateLeft(
                  ((2 * Math.PI * n.x) / b.clientHeight) * h.rotateSpeed
                ),
                h.rotateUp(
                  ((2 * Math.PI * n.y) / b.clientHeight) * h.rotateSpeed
                ),
                L.copy(l)))
          : E === y.DOLLY
          ? !0 !== h.noZoom &&
    ...
    function d(a) {
      if (!1 !== h.enabled && !0 !== h.noZoom && E === y.NONE) {
        ...
        0 < b
          ? ((h.object.fov =
              h.object.fov < h.maxFov ? h.object.fov + 1 : h.maxFov),
            h.object.updateProjectionMatrix())
          : 0 > b &&
            ((h.object.fov =
              h.object.fov > h.minFov ? h.object.fov - 1 : h.minFov),
            h.object.updateProjectionMatrix())
        h.dispatchEvent(F)
        h.dispatchEvent(T)
        h.dispatchEvent(V)
    ...
    function t(a) {
      if (
        ...
        var b =
          h.momentum && !h.autoRotate
            ? h.momentumKeydownFactor * h.momentumFactor
            : h.momentumKeydownFactor
        switch (a.keyCode) {
          case h.keys.UP:
    ...
    function k(a) {
      if (!1 !== h.enabled) {
        ...
        switch (a.touches.length) {
          case 1:
            if (!0 === h.noRotate) break
            if (E !== y.TOUCH_ROTATE) break
            l.set(a.touches[0].pageX, a.touches[0].pageY)
            n.subVectors(l, L)
    ...
    function R() {
      !1 !== h.enabled && (h.dispatchEvent(V), (E = y.NONE))
    }
    this.object = a
    ...
    this.momentumKeydownFactor = 0.05
    this.momentum = !0
    ...
    this.pan = function (a, b) {
      ...
      if (h.object instanceof c.PerspectiveCamera) {
        ...
        h.object instanceof c.OrthographicCamera
          ? (h.panLeft((a * (h.object.right - h.object.left)) / f.clientWidth),
            h.panUp((b * (h.object.top - h.object.bottom)) / f.clientHeight))
          : console.warn(
              'WARNING: OrbitControls.js encountered an unknown camera type - pan disabled.'
            )
    }
    this.dollyIn = function (a) {
      void 0 === a && (a = Math.pow(0.95, h.zoomSpeed))
      h.object instanceof c.PerspectiveCamera
        ? (M /= a)
        : h.object instanceof c.OrthographicCamera
    ...
    this.update = function (a) {
      ...
      this.autoRotate &&
        E === y.NONE &&
        this.rotateLeft(((2 * Math.PI) / 60 / 60) * h.autoRotateSpeed)
      !0 === this.enableDamping &&
        this.speedLimit !== Number.MAX_VALUE &&
        ((K = c.Math.clamp(K, -this.speedLimit, this.speedLimit)),
      ...
      this.autoRotate ||
      !0 !== this.enableDamping ||
      ((!this.momentum || (E !== y.ROTATE && E !== y.TOUCH_ROTATE)) &&
        E !== y.NONE)
        ? (H = K = 0)
        : ((K *= this.dampingFactor), (H *= this.dampingFactor))
      M = 1
      N.set(0, 0, 0)
      if (
        1e-7 < O.distanceToSquared(this.object.position) ||
        1e-7 < 8 * (1 - P.dot(this.object.quaternion))
      )
    ...
    this.domElement.addEventListener('mousedown', e, { passive: !1 })
    this.domElement.addEventListener('mousewheel', d, { passive: !1 })
    this.domElement.addEventListener('DOMMouseScroll', d, { passive: !1 })
    this.domElement.addEventListener('touchstart', g, { passive: !1 })
    this.domElement.addEventListener('touchend', R, { passive: !1 })
    this.domElement.addEventListener('touchmove', k, { passive: !1 })
    window.addEventListener('keyup', x, { passive: !1 })
  ...
  function pa(a) {
    ...
    var e = function (a) {
        ...
        f -= b.initialOffset
        0 > f && (f += 360)
        b.deviceOrientation = { alpha: f, beta: e, gamma: a }
      },
      f = function () {
      ...
      d = (function () {
        var a = new c.Vector3(0, 0, 1),
          b = new c.Euler(),
          f = new c.Quaternion(),
          e = new c.Quaternion(-Math.sqrt(0.5), 0, 0, Math.sqrt(0.5))
  ...
  function ya(a) {
    ...
    var d = new c.Vector2(0.441, 0.156),
      x = new c.PlaneBufferGeometry(1, 1, 10, 20)
    ...
    for (var h = 0, L = l.length / 3; h < L; h++) {
      ...
      n = 1.5 + (d.x + d.y * n) * n
      var p = h < t ? 0 : 1
      l[3 * h] = (g.x / n) * 1.5 - 0.5 + p
      l[3 * h + 1] = (g.y / n) * 3
      k[2 * h] = 0.5 * (k[2 * h] + p)
    }
    x.attributes.position.array = l
    x.attributes.uv.array = k
    d = new c.MeshBasicMaterial({ map: m.texture })
    x = new c.Mesh(x, d)
    e.add(x)
  ...
  function qa(a) {
    ...
    this.handlerTap = this.onTap.bind(this, { clientX: n / 2, clientY: p / 2 })
  ...
  var za = '^0.117.0'.replace(/[^0-9.]/g, ''),
    M = { ORBIT: 0, DEVICEORIENTATION: 1 },
    z = { UNKNOWN: 0, NORMAL: 1, CARDBOARD: 2, STEREO: 3 },
    N = { TAB: 0, SBS: 1 },
    g = {
    ...
    ra = {
      load: function (a, b, e, f) {
        ...
        c.Cache.enabled = !0
        var m, d, x, g
        for (g in C) C.hasOwnProperty(g) && a === C[g] && (m = g)
        ...
        if (0 === a.indexOf('data:'))
          return k.addEventListener('load', h, !1), (k.src = a), k
        ...
        m.addEventListener('progress', function (a) {
          if (a) {
            var b = a.loaded,
              f = a.total
            a.lengthComputable && e({ loaded: b, total: f })
          }
        })
        m.addEventListener('loadend', function (a) {
          a &&
            ((d = new Uint8Array(a.currentTarget.response)),
            (x = new window.Blob([d])),
        ...
        a.map(function (a, c) {
          ra.load(
            ...
            function (a) {
              ...
              g++
              6 === g &&
                ((d.needsUpdate = !0), e({ loaded: g, total: 6 }), b(d))
            },
            function (a) {
              t[c] = { loaded: a.loaded, total: a.total }
              k.loaded = 0
              m = k.total = 0
              for (var b in t)
                m++, (k.loaded += t[b].loaded), (k.total += t[b].total)
  ...
  l.prototype = Object.assign(Object.create(c.EventDispatcher.prototype), {
    ...
    start: function (a) {
      ...
      return this.getDevices().then(function (f) {
        if (!f || 0 === f.length) throw Error('no video device found')
    ...
    playVideo: function () {
      var a = this.element
      a && (a.play(), this.dispatchEvent({ type: g.MEDIA.PLAY }))
    },
    pauseVideo: function () {
      var a = this.element
      a && (a.pause(), this.dispatchEvent({ type: g.MEDIA.PAUSE }))
    },
    ...
    updateUniformByFormat: function (a, b) {
      ...
      switch (a) {
        case N.TAB:
          ...
          break
        case N.SBS:
          e.set(0.5, 1), b.set(0, 0), f.set(0, 0), c.set(0.5, 0)
      }
    },
  ...
  p.prototype = Object.assign(Object.create(c.Sprite.prototype), {
    ...
    updateCanvasArcByProgress: function (a) {
      ...
      b.beginPath()
      0 === a
        ? (b.arc(k, d, e / 16, 0, 2 * Math.PI), (b.fillStyle = t), b.fill())
        : (b.arc(k, d, e / 4 - 3, -Math.PI / 2, -Math.PI / 2 + g),
          (b.strokeStyle = t),
          (b.lineWidth = 3),
          b.stroke())
      b.closePath()
      ...
      var a = this,
        ...
        h = function () {
          ...
          1 <= u &&
            ...
            a.dispatchEvent({ type: g.RETICLE.RETICLE_RIPPLE_END }))
          c.map.needsUpdate = !0
        }
      this.dispatchEvent({ type: g.RETICLE.RETICLE_RIPPLE_START })
      h()
    },
    show: function () {
      this.visible = !0
    ...
    start: function (a) {
      this.autoSelect &&
        (this.dispatchEvent({ type: g.RETICLE.RETICLE_START }),
      ...
      this.startTimestamp &&
        ...
        this.dispatchEvent({ type: g.RETICLE.RETICLE_END }))
    },
    update: function () {
      this.timerId = window.requestAnimationFrame(this.update.bind(this))
      var a = (performance.now() - this.startTimestamp) / this.dwellTime
      this.updateCanvasArcByProgress(a)
      this.dispatchEvent({ type: g.RETICLE.RETICLE_UPDATE, progress: a })
      1 <= a &&
        (window.cancelAnimationFrame(this.timerId),
  ...
  var q = (function (a, b) {
      ...
      update: function (a, b) {
        ...
        for (a = void 0 !== a ? a : e.now(); 0 < f.length; ) {
          ...
          for (var c = 0; c < f.length; c++) {
            ...
            m &&
              !1 === m.update(a) &&
              ((m._isPlaying = !1), b || delete this._tweens[f[c]])
          }
    ...
    e.Tween.prototype = {
      ...
      start: function (a) {
        ...
        for (var b in this._valuesEnd) {
          ...
          void 0 !== this._object[b] &&
            ((this._valuesStart[b] = this._object[b]),
            !1 === this._valuesStart[b] instanceof Array &&
      ...
      update: function (a) {
        ...
        for (b in this._valuesEnd)
          if (void 0 !== this._valuesStart[b]) {
            var c = this._valuesStart[b] || 0,
              d = this._valuesEnd[b]
            d instanceof Array
              ? (this._object[b] = this._interpolationFunction(d, e))
              : ('string' === typeof d &&
                  (d =
        ...
        null !== this._onUpdateCallback &&
          this._onUpdateCallback(this._object, f)
        if (1 === f)
          if (0 < this._repeat) {
    ...
    e.Easing = {
      ...
      Bounce: {
        ...
        InOut: function (a) {
          return 0.5 > a
            ? 0.5 * e.Easing.Bounce.In(2 * a)
            : 0.5 * e.Easing.Bounce.Out(2 * a - 1) + 0.5
        }
      }
    }
    e.Interpolation = {
      ...
      Bezier: function (a, b) {
        for (
          var f = 0,
            c = a.length - 1,
            d = Math.pow,
            m = e.Interpolation.Utils.Bernstein,
            g = 0;
          g <= c;
          g++
        )
      ...
      CatmullRom: function (a, b) {
        ...
        return a[0] === a[f]
          ? (0 > b && (d = Math.floor((c = f * (1 + b)))),
            m(a[(d - 1 + f) % f], a[d], a[(d + 1) % f], a[(d + 2) % f], c - d))
          : 0 > b
          ? a[0] - (m(a[0], a[0], a[1], a[1], -c) - a[0])
          : 1 < b
          ? a[f] - (m(a[f], a[f], a[f - 1], a[f - 1], c - f) - a[f])
          : m(
              a[d ? d - 1 : 0],
              a[d],
              a[f < d + 1 ? f : d + 1],
  ...
  v.prototype = Object.assign(Object.create(c.Sprite.prototype), {
    ...
    onHoverStart: function (a) {
      if (this.getContainer()) {
        ...
        c &&
          ...
          (b = c.right),
          (e = c.style),
          this.mode === z.CARDBOARD || this.mode === z.STEREO
            ? ((e.display = 'none'),
              (a.style.display = 'block'),
              (b.style.display = 'block'),
              (c._width = a.clientWidth),
              (c._height = a.clientHeight))
            : ((e.display = 'block'),
    ...
    translateElement: function (a, b) {
      if (this.element._width && this.element._height && this.getContainer()) {
        ...
        !f.left ||
        !f.right ||
        (a === e.clientWidth / 2 && b === e.clientHeight / 2)
          ? this.setElementStyle(
              'transform',
              f,
              'translate(' + k + 'px, ' + l + 'px)'
            )
          : ((k = e.clientWidth / 4 - c + (a - e.clientWidth / 2)),
    ...
    show: function (a) {
      ...
      var b = this.hideAnimation,
        ...
        f = this.material
      this.animated
        ? (b.stop(), e.delay(a).start())
        : (this.enableRaycast(!0), (f.opacity = 1))
    },
    hide: function (a) {
      a = void 0 === a ? 0 : a
      var b = this.hideAnimation,
        ...
        f = this.material
      this.animated
        ? (e.stop(), b.delay(a).start())
        : (this.enableRaycast(!1), (f.opacity = 0))
    },
  ...
  S.prototype = Object.assign(Object.create(c.EventDispatcher.prototype), {
      ...
      if (this.container) {
        ...
        b.toggle = function () {
          ...
          b.style.transform =
            b.style.webkitTransform =
            b.style.msTransform =
              b.isHidden ? 'translateY(0)' : 'translateY(-100%)'
          b.style.opacity = a
        }
        ...
        b.dispose = function () {
          ...
          a.settingElement &&
            (b.removeChild(a.settingElement),
            a.settingElement.dispose(),
            (a.settingElement = null))
          a.videoElement &&
            (b.removeChild(a.videoElement),
    ...
    createDefaultMenu: function () {
      var a = this,
        b = function (b, f) {
          return function () {
            a.dispatchEvent({ type: g.VIEWER_HANDLER, method: b, data: f })
          }
        }
      return [
        {
        ...
        },
        {
          ...
          subMenu: [
            ...
            { title: 'Cardboard', handler: b('enableEffect', z.CARDBOARD) },
            { title: 'Stereoscopic', handler: b('enableEffect', z.STEREO) }
          ]
        }
      ]
    },
    ...
    createFullscreenButton: function () {
      function a() {
        f &&
          ...
          (d.style.backgroundImage = e
            ? 'url("' + C.FullscreenLeave + '")'
            : 'url("' + C.FullscreenEnter + '")'))
        b.dispatchEvent({ type: g.VIEWER_HANDLER, method: 'onWindowResize' })
        f = !0
      }
      var b = this,
        e = !1,
      ...
      if (
        ...
        var d = this.createCustomItem({
          style: { backgroundImage: 'url("' + C.FullscreenEnter + '")' },
          onTap: function (a) {
            a.preventDefault()
            a.stopPropagation()
            f = !1
    ...
    createVideoControlButton: function () {
      ...
      b.update = function (a) {
        ...
        this.style.backgroundImage =
          'url("' + (this.paused ? C.VideoPlay : C.VideoPause) + '")'
      }
      return b
    },
    createVideoControlSeekbar: function () {
      function a(a) {
        ...
        c.container.addEventListener('mousemove', b, { passive: !0 })
        c.container.addEventListener('mouseup', e, { passive: !0 })
        c.container.addEventListener('touchmove', b, { passive: !0 })
        c.container.addEventListener('touchend', e, { passive: !0 })
      }
      function b(a) {
        d &&
          ((n =
    ...
    createMainMenu: function (a) {
      ...
      for (var d = 0; d < a.length; d++) {
        ...
        g.addIcon().addEventListener(
          e.TOUCH_ENABLED ? 'touchend' : 'click',
          b,
          !1
        )
        a[d].subMenu &&
          0 < a[d].subMenu.length &&
          g
            .addSelection(a[d].subMenu[0].title)
            .addSubMenu(a[d].title, a[d].subMenu)
      }
      return c
    },
    createSubMenu: function (a, b) {
      ...
      g.addHeader(a)
        .addIcon(void 0, !0, !0)
        .addEventListener(c.TOUCH_ENABLED ? 'touchend' : 'click', e, !1)
    ...
    createCustomItem: function (a) {
      ...
      a.onTap &&
        e.addEventListener(b.TOUCH_ENABLED ? 'touchend' : 'click', a.onTap, !1)
      e.dispose = function () {
    ...
    mergeStyleOptions: function (a, b) {
      b = void 0 === b ? {} : b
      for (var e in b) b.hasOwnProperty(e) && (a.style[e] = b[e])
      return a
    },
    dispose: function () {
      this.barElement &&
  ...
  var Aa = {
    texture: { value: new c.Texture() },
    repeat: { value: new c.Vector2(1, 1) },
    offset: { value: new c.Vector2(0, 0) },
    opacity: { value: 1 }
  }
  k.prototype = Object.assign(Object.create(c.Mesh.prototype), {
    ...
    add: function (a) {
      ...
      a instanceof v &&
        ((b = this.container) &&
          a.dispatchEvent({ type: g.CONTAINER, container: b }),
        a.dispatchEvent({
    ...
    load: function (a) {
      a = void 0 === a ? !0 : a
      this.dispatchEvent({ type: g.LOAD_START })
      if (a) this.onLoad()
    },
    onClick: function (a) {
      a.intersects &&
    ...
    onLoad: function () {
      this.loaded = !0
      this.dispatchEvent({ type: g.LOADED })
      this.dispatchEvent({ type: g.LOAD })
      this.dispatchEvent({ type: g.READY })
    },
    onProgress: function (a) {
      this.dispatchEvent({ type: g.PROGRESS, progress: a })
    },
    onError: function () {
      this.dispatchEvent({ type: g.READY })
    },
    ...
    setupTransitions: function () {
      ...
      this.enterTransition = new q.Tween(this)
        .easing(q.Easing.Quartic.Out)
        .onComplete(
          function () {
            this.dispatchEvent({ type: g.ENTER_COMPLETE })
          }.bind(this)
        )
        .start()
    ...
    fadeIn: function (a) {
      ...
      this.dispatchEvent({ type: g.FADE_IN })
      var b = (
        ...
        e = function () {
          this.visible = !0
          this.dispatchEvent({ type: g.ENTER_FADE_START })
        }.bind(this),
        c = function () {
          this.toggleInfospotVisibility(!0, a / 2)
          this.dispatchEvent({ type: g.ENTER_FADE_COMPLETE })
        }.bind(this)
      this.fadeOutAnimation.stop()
      this.fadeInAnimation = new q.Tween(b)
        .to({ value: 1 }, a)
        .easing(q.Easing.Quartic.Out)
        .onStart(e)
        .onComplete(c)
    ...
    fadeOut: function (a) {
      a = void 0 === a ? this.animationDuration : a
      this.dispatchEvent({ type: g.FADE_OUT })
      var b = (
          this.material.uniforms
            ? this.material.uniforms
            : { opacity: this.material.opacity }
        ...
        e = function () {
          this.visible = !1
          this.dispatchEvent({ type: g.LEAVE_COMPLETE })
        }.bind(this)
      this.fadeInAnimation.stop()
      this.fadeOutAnimation = new q.Tween(b)
        .to({ value: 0 }, a)
        .easing(q.Easing.Quartic.Out)
        .onComplete(e)
        .start()
    ...
    onEnter: function () {
      ...
      this.dispatchEvent({ type: g.ENTER })
      this.leaveTransition.stop()
      this.enterTransition
        .to({}, a)
        .onStart(
          function () {
            this.dispatchEvent({ type: g.ENTER_START })
            this.loaded ? this.dispatchEvent({ type: g.READY }) : this.load()
          }.bind(this)
        )
        .start()
      this.children.forEach(function (a) {
    ...
    onLeave: function () {
      ...
      this.leaveTransition
        ...
        .onStart(
          function () {
            this.dispatchEvent({ type: g.LEAVE_START })
            this.fadeOut(a)
            this.toggleInfospotVisibility(!1)
          }.bind(this)
        )
        .start()
      this.dispatchEvent({ type: g.LEAVE })
      this.traverse(function (a) {
        return a.dispatchEvent({ type: 'panorama-leave' })
      })
      this.active = !1
    },
    dispose: function () {
      function a(b) {
        for (
          var e = b.geometry, c = b.material, d = b.children.length - 1;
          0 <= d;
          d--
        )
          a(b.children[d]), b.remove(b.children[d])
        b instanceof v && b.dispose()
        e && (e.dispose(), (b.geometry = null))
        c && (c.dispose(), (b.material = null))
      }
      var b = this.material
      b &&
        b.uniforms &&
        b.uniforms.texture &&
        b.uniforms.texture.value.dispose()
  ...
  n.prototype = Object.assign(Object.create(k.prototype), {
    ...
    load: function (a) {
      ...
      else if (a instanceof HTMLImageElement) this.onLoad(new c.Texture(a))
    },
    onLoad: function (a) {
  ...
  K.prototype = Object.assign(Object.create(k.prototype), {
    ...
    createMaterial: function () {
      return new c.MeshBasicMaterial({ color: 0, opacity: 0, transparent: !0 })
    },
    getTexture: function () {
      return null
    }
  ...
  fa.prototype = Object.assign(Object.create(U.prototype), { constructor: fa })
  var sa =
  ...
  D.prototype = Object.assign(Object.create(k.prototype), {
    ...
    load: function () {
      ...
      2 < u.readyState
        ? d.call(this)
        : (0 === u.querySelectorAll('source').length &&
    ...
    muteVideo: function () {
      var a = this.videoElement
      a && !a.muted && (a.muted = !0)
      this.dispatchEvent({ type: g.MEDIA.VOLUME_CHANGE })
    },
  ...
  Object.assign(T.prototype, {
    ...
    composeFromTile: function (a, b, e) {
      ...
      var g = Math.floor(a / c),
        k = Math.floor(b / d)
      this._ctx[k * this._wc + g].drawImage(
        e,
        0,
        0,
        e.width,
    ...
    composePanorama: function () {
      ...
      for (var c = this._parameters.useWebGL, d = 0; d < b; d++)
        for (
          var g = {}, k = 0;
          k < a;
          g = { $jscomp$loop$prop$url$2: g.$jscomp$loop$prop$url$2 }, k++
        )
          (g.$jscomp$loop$prop$url$2 =
    ...
    loadPano: function (a) {
      ...
      this._panoClient.getPanoramaById(a, function (a, c) {
        c === google.maps.StreetViewStatus.OK &&
          ((b.result = a),
  ...
  ea.prototype = Object.assign(Object.create(n.prototype), {
    ...
    setupGoogleMapAPI: function (a) {
      ...
      if (document.querySelector('#panolens-gmapscript')) b()
      else {
  ...
  var Ba = {
    tDiffuse: { value: new c.Texture() },
    resolution: { value: 1 },
    transform: { value: new c.Matrix4() },
    zoom: { value: 1 },
    opacity: { value: 1 }
  }
  H.prototype = Object.assign(Object.create(n.prototype), {
    ...
    createGeometry: function (a) {
      return new c.PlaneBufferGeometry(a, 0.5 * a)
    },
    ...
    onMouseMove: function (a) {
      switch ((a.touches && a.touches.length) || 1) {
        case 1:
          var b = 0 <= a.clientX ? a.clientX : a.touches[0].clientX
          a = 0 <= a.clientY ? a.clientY : a.touches[0].clientY
          var e = 0.4 * c.Math.degToRad(b - this.userMouse.x),
            d = 0.4 * c.Math.degToRad(a - this.userMouse.y)
          this.dragging &&
            (this.quatA.setFromAxisAngle(this.vectorY, e),
    ...
    onLoad: function (a) {
      ...
      this.onUpdateCallback()
      this.dispatchEvent({ type: g.VIEWER_HANDLER, method: 'disableControl' })
  ...
  O.prototype = Object.assign(Object.create(n.prototype), {
    ...
    onLoad: function (a) {
      var b = a.image
      this.stereo.updateUniformByFormat(
        4 === b.width / b.height ? N.SBS : N.TAB,
        this.material.uniforms
      )
      this.material.uniforms.texture.value = a
      n.prototype.onLoad.call(this, a)
  ...
  P.prototype = Object.assign(Object.create(D.prototype), {
    ...
    onLoad: function (a) {
      var b = a.image
      this.stereo.updateUniformByFormat(
        4 === b.videoWidth / b.videoHeight ? N.SBS : N.TAB,
        this.material.uniforms
      )
      this.material.uniforms.texture.value = a
  ...
  B.prototype = Object.assign(Object.create(k.prototype), {
    ...
    onPanolensCamera: function (a) {
      Object.assign(this.defaults, { fov: a.fov })
      this.camera = a
    },
    ...
    enableControl: function () {
      this.active &&
        ($jscomp.makeIterator(this.controls).next().value.enabled = !0)
    },
    disableControl: function () {
      this.active &&
        ($jscomp.makeIterator(this.controls).next().value.enabled = !1)
    },
    load: function () {
      k.prototype.load.call(this, !1)
      var a = this.readyCallback,
        b = this.loadedCallback
      this.PanoMoments = new wa(
        this.identifier,
    ...
    renderCallback: function (a, b) {
      this.momentData ||
        ...
        (a.format = c.RGBFormat),
        this.updateTexture(a),
        this.dispatchEvent({ type: g.PANOMOMENT.FIRST_FRAME_DECODED }),
        k.prototype.onLoad.call(this))
    },
    readyCallback: function () {
      this.dispatchEvent({ type: g.PANOMOMENT.READY })
    },
    loadedCallback: function () {
      this.dispatchEvent({ type: g.PANOMOMENT.COMPLETED })
    },
    setPanoMomentYaw: function (a) {
      ...
      ;(b !== g.PANOMOMENT.READY && b !== g.PANOMOMENT.COMPLETED) ||
        !e ||
        d((a / 360) * k)
    },
    enter: function () {
  ...
  Y.prototype = Object.assign(Object.create(B.prototype), {
    ...
    attachFOVListener: function (a) {
      ...
      a
        ? b.addEventListener('fov', this.viewerResetControlLimits)
        : b.removeEventListener('fov', this.viewerResetControlLimits)
    },
    updateHeading: function () {
      this.momentData &&
        ((this.material.uniforms.offset.value.x =
          (this.momentData.max_horizontal_fov / 360 + 0.25) % 1),
        this.resetControlLimits(!1),
    ...
    resetAzimuthAngleLimits: function (a) {
      ...
      if (e.contains_parallax || a)
        (e = c.Math.degToRad(
          (0.95 * e.min_vertical_fov - this.camera.fov) / 2
        )),
          (e = {
            minPolarAngle: Math.PI / 2 - e,
            maxPolarAngle: Math.PI / 2 + e
          }),
          Object.assign(b, a ? { minPolarAngle: g, maxPolarAngle: d } : e)
    },
    calculateFOV: function (a, b) {
      var c = this.camera.aspect
      return (
        ((2 * Math.atan(Math.tan((a * Math.PI) / 360) * (b ? c : 1 / c))) /
          Math.PI) *
        180
      )
    },
    resetFOVLimits: function (a) {
      ...
      k > 0.95 * b.min_horizontal_fov
        ? (c.fov = this.calculateFOV(0.95 * b.min_horizontal_fov, !1))
        : k < d.minFov && (c.fov = this.calculateFOV(d.minFov, !1))
      c.fov = a ? g : c.fov
    ...
    resetControlLimits: function (a) {
      a = void 0 === a ? !1 : a
      this.momentData &&
        (this.resetFOVLimits(a), this.resetAzimuthAngleLimits(a))
    },
    enter: function () {
  ...
  na.prototype = Object.assign(Object.create(B.prototype), {
    ...
    update2DGeometryScale: function (a) {
      a = void 0 === a ? !1 : a
      if (this.momentData)
        if ((this.geometry.scale(1 / this.scale2D.x, 1 / this.scale2D.y, 1), a))
  ...
  qa.prototype = Object.assign(Object.create(c.EventDispatcher.prototype), {
    ...
    setupRenderer: function (a, b) {
      a = void 0 === a ? new c.WebGLRenderer({ alpha: !0, antialias: !1 }) : a
      var e = b.clientWidth,
        d = b.clientHeight
    ...
    setupControls: function (a, b) {
      ...
      c && ((b.minPolarAngle = Math.PI / 2), (b.maxPolarAngle = Math.PI / 2))
    ...
    setupContainer: function (a) {
      if (a) return (a._width = a.clientWidth), (a._height = a.clientHeight), a
    ...
    add: function (a) {
      ...
      c.add(a)
      a.addEventListener &&
        a.addEventListener(g.VIEWER_HANDLER, this.eventHandler.bind(this))
      a instanceof k &&
        (a.dispatchEvent({ type: g.CONTAINER, container: b }),
        a.dispatchEvent({ type: 'panolens-scene', scene: c }),
        a.dispatchEvent({ type: g.CAMERA, camera: d }),
        a.dispatchEvent({ type: g.CONTROLS, controls: m }),
        this.addPanoramaEventListener(a),
        this.panorama || (this.setPanorama(a), this.setControlCenter(l)))
    },
    remove: function (a) {
      a.removeEventListener &&
        a.removeEventListener(g.VIEWER_HANDLER, this.eventHandler.bind(this))
      this.scene.remove(a)
    },
      ...
      if (a instanceof k && b !== a) {
        ...
        if (b) {
          if (a instanceof B) {
            ...
            if (b instanceof B) b.onLeave()
          }
          b._onReady &&
            (b.removeEventListener(g.READY, b._onReady), delete b._onReady)
          b._onEnterFadeStart &&
            (b.removeEventListener(g.ENTER_FADE_START, b._onEnterFadeStart),
            delete b._onEnterFadeStart)
        }
        a._onLeaveComplete &&
          (a.removeEventListener(g.LEAVE_COMPLETE, a._onLeaveComplete),
        ...
        var d = function () {
            ...
            a.active &&
              ((a instanceof B &&
                (!(a instanceof B) ||
                  (b instanceof B && b._onLeaveComplete))) ||
                a.fadeIn())
          },
          m = function () {
            if (b && b.active) b.onLeave()
    ...
    enableEffect: function (a) {
      if (this.mode !== a)
        if (a === z.NORMAL) this.disableEffect()
        else {
          this.mode = a
          ...
          this.render()
          this.camera.fov = b
          this.dispatchEvent({ type: g.MODE_CHANGE, mode: this.mode })
        }
    },
    ...
    reverseDraggingDirection: function () {
      console.warn(
        'reverseDragging option is deprecated. Please use rotateSpeed to indicate strength and direction'
      )
    ...
    calculateCameraDirectionDelta: function (a) {
      ...
      d = d < -Math.PI ? d + 2 * Math.PI : d
      b = Math.abs(
        e.angleTo(b) + (0 >= e.y * g.y ? g.angleTo(a) : -g.angleTo(a))
      )
      b *= g.y < e.y ? 1 : -1
      return { left: d, up: b }
    },
    ...
    tweenControlCenter: function (a, b, c) {
      a instanceof Array && ((c = a[2]), (b = a[1]), (a = a[0]))
      b = void 0 !== b ? b : 1e3
      ...
      this.tweenLeftAnimation = new q.Tween(k)
        .to({ left: a }, b)
        .easing(c)
        .onUpdate(
          function (a) {
        ...
        .start()
      this.tweenUpAnimation = new q.Tween(k)
        .to({ up: e }, b)
        .easing(c)
        .onUpdate(
          function (a) {
    ...
    onWindowResize: function (a, b) {
      var c =
        this.container.classList.contains(g.CONTAINER) ||
      ...
      ;(this.options.enableReticle || this.tempEnableReticle) &&
        this.updateReticleEvent()
      this.dispatchEvent({ type: g.WIDNOW_RESIZE, width: d, height: k })
      this.scene.traverse(function (a) {
        a.dispatchEvent &&
          a.dispatchEvent({ type: g.WIDNOW_RESIZE, width: d, height: k })
      })
    },
      ...
      if (this.panorama) {
        ...
        if ('click' === b)
          this.panorama.dispatchEvent({
            ...
            g &&
              g.dispatchEvent &&
              g.dispatchEvent({ type: 'click', mouseEvent: a })
        else {
          this.panorama.dispatchEvent({
            type: 'hover',
            intersects: c,
          ...
          d &&
            ...
            (g &&
              g.dispatchEvent &&
              g.dispatchEvent({ type: 'hover', mouseEvent: a }),
            this.pressEntityObject &&
              this.pressEntityObject.dispatchEvent &&
              this.pressEntityObject.dispatchEvent({
        ...
        if (g && g instanceof v) {
          if (((this.infospot = g), 'click' === b)) return !0
    ...
    updateReticleEvent: function () {
      ...
      this.removeUpdateCallback(this.handlerTap)
      this.handlerTap = this.onTap.bind(this, { clientX: a, clientY: b })
      this.addUpdateCallback(this.handlerTap)
    },
    ...
    onPanoramaDispose: function (a) {
      ...
      b.traverse(function (a) {
        a instanceof k &&
          (a.linkedSpots = a.linkedSpots.map(c).filter(function (a) {
            return !!a
          }))
      })
  ...
  '117' != c.REVISION &&
    console.warn(
      'three.js version is not matched. Please consider use the target revision 117'
    )
  window.TWEEN = q
  d.BasicPanorama = fa
  d.CONTROLS = M
